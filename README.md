...
## Gereksinimler
Scripti çalıştırmadan önce, Book API kimlik bilgilerinizi ayarlamanız gerekiyor. Bir Google Geliştirici hesabı oluşturun ve API kimlik bilgilerini edinin (ücretsiz bir şekilde alabilirsiniz):
...
## Requirements
Before running the script, you need to set up your Book API credentials. Create a Google Developer account and obtain API credentials (you can obtain them for free):
